...
namespace Thunder.BuildSystem.Sdk.Internal
{
    ...
    internal class MSBuildLogger : LoggerBase, ILogger
    {
        ...
        private delegate void LogMessageWithDetails(
            string subcategory,
            string code,
            string helpKeyword,
            string file,
        ...
        private delegate void LogErrorWithDetails(
            string subcategory,
            string code,
            string helpKeyword,
            string file,
        ...
        private delegate void LogMessageAsString(
            MessageImportance importance,
            string message,
            params object[] messageArgs);

        private delegate void LogErrorAsString(
            string message,
            params object[] messageArgs);
