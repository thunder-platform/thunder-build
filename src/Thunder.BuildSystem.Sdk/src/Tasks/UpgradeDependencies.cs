...
namespace Thunder.BuildSystem.Sdk.Tasks
{
    ...
    public class UpgradeDependencies : Microsoft.Build.Utilities.Task, ICancelableTask
    {
        ...
        public async Task<bool> ExecuteAsync()
        {
            ...
            {
                Log.LogThunderBuildWarning(ThunderBuildErrors.PackageRefPropertyGroupNotFound, $"No PropertyGroup with Label=\"{DependencyVersionsFile.PackageVersionsLabel}\" could be found in {DependenciesFile}");
            }
